...
public class CommentsDataSource {
    ...
    private String[] allColumns = { DatabaseHelper.COLUMN_ID,
            DatabaseHelper.COLUMN_COMMENT,DatabaseHelper.COLUMN_DATE,DatabaseHelper.COLUMN_OWNER };
    ...
    public Comment createComment(String comment, String date, String owner) {

        //Add to database
        ContentValues values = new ContentValues();
        values.put(DatabaseHelper.COLUMN_COMMENT, comment);
        values.put(DatabaseHelper.COLUMN_DATE, date);
        values.put(DatabaseHelper.COLUMN_OWNER, owner);
